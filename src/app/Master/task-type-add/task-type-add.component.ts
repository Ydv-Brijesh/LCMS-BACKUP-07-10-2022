...
@Component({
  selector: 'app-task-type-add',
  templateUrl: './task-type-add.component.html',
  styleUrls: ['./task-type-add.component.css']
})
export class TaskTypeAddComponent implements OnInit{
  ...
  clickFunction() {
    ...
    if (this.saveForm.invalid) {
      ...
      this.ho
        .saveTaskType(this.saveForm.value)
        .subscribe((data: any) => {
          console.log('saved');
