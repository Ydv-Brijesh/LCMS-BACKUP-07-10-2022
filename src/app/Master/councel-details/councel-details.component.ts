...
@Component({
  selector: 'app-councel-details',
  templateUrl: './councel-details.component.html',
  styleUrls: ['./councel-details.component.css']
})
export class CouncelDetailsComponent implements OnInit {
  id: any;
  EditData: any;
  saveForm: any;
