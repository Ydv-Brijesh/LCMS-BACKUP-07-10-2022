...
@Component({
  selector: 'app-ce-add',
  templateUrl: './ce-add.component.html',
  styleUrls: ['./ce-add.component.css']
})
export class CEAddComponent implements OnInit {
  ...
  clickFunction() {
    ...
    if (this.saveForm.invalid) {
      ...
      this.ho
        .saveCE(this.saveForm.value)
        .subscribe((data: any) => {
          console.log('saved');
          this.toast.showSuccess(
            'Congratulation!, Data has been submited.'
          );
          window.location.href = '/ce-list';
          // this.saveForm.reset()
        });
    }
  }
