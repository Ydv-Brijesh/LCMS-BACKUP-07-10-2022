...
@Component({
  selector: 'app-govt-section-add',
  templateUrl: './govt-section-add.component.html',
  styleUrls: ['./govt-section-add.component.css']
})
export class GovtSectionAddComponent implements OnInit {
  ...
  clickFunction() {
    ...
    if (this.saveForm.invalid) {
      ...
      this.ho
        .saveSection(this.saveForm.value)
        .subscribe((data: any) => {
          console.log('saved');
