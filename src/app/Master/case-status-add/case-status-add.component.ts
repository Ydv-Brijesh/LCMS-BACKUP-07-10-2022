...
@Component({
  selector: 'app-case-status-add',
  templateUrl: './case-status-add.component.html',
  styleUrls: ['./case-status-add.component.css']
})
export class CaseStatusAddComponent implements OnInit {
  ...
  clickFunction() {
    ...
    if (this.saveForm.invalid) {
      ...
      this.ho
        .saveCaseStatus(this.saveForm.value)
        .subscribe((data: any) => {
          console.log('saved');
